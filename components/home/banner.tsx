...
import Link from "next/link";// Assuming you want to import from Lucide
  ...
  return (
    <section className="lg:max-w-6xl mx-auto flex flex-col z-0 items-center justify-center py-28 sm:pt-32 transition-all animate-in">
      <h1 className="py-6 text-center">
        ...
        <span className="underline underline-offset-8 decoration-dashed decoration-purple-200"> captivating</span>{" "}
        blog posts
      </h1>
      ...
      >
        <Link href="/#pricing" className="flex gap-2 items-center">
          ...
          <ArrowRight className="ml-2 w-10 h-10 animate-pulse"/>
        </Link>
      </Button>
    </section>
  );
