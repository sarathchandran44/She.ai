...
{
    name: 'Pro',
    description:"All blog Post, lets's go!",
    price:'39',
...
<div className="relative flex justify-center flex-col lg:flex-row items-center lg:items-stretch gap-8"> 
    <div className="relative w-full max-w-lg">
        <div className="relative flex flex-col h-full gap-4 lg:gap-8 z-10 p-8 rounded-box border-[1px] border-gray-500/20 rounded-2xl">
        <div className="flex justify-between items-center gap-4">
            <div>
            <p className="text-lg lg:text-xl font-bold capitalize">Basics</p>
        ...
        <div className="space-y-2">
            <Button variant={'link'} className="hover:no-underline">
                ...
                items-center ">Get SpeakEasy <ArrowRight size={18}/></Link>
            </Button>
        </div>
        </div>
    </div>
